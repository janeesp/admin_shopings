...
import 'package:shoping_admin/features/add_page/banner/add_banners.dart';
...
class _TabPageState extends State<EditBanner>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: TabBarView(
        controller: tabController,
        children: [AddBanners(), DeletBanneer()],
      ),
    );
  }
}

class DeletBanneer extends StatefulWidget {
  const DeletBanneer({super.key});

  @override
  State<DeletBanneer> createState() => _DeletBanneerState();
}

class _DeletBanneerState extends State<DeletBanneer> {
