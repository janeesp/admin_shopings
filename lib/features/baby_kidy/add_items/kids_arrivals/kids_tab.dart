...
import 'package:shoping_admin/features/baby_kidy/add_items/kids_arrivals/update_kids.dart';

import '../../../../main.dart';
import '../../../model_page/baby_model.dart';
import 'add_baby_items.dart';
...
class _TabPageState extends State<KidsTab> with SingleTickerProviderStateMixin {
                                                              ...
                                                              InkWell(
                                                                onTap: () {
                                                                  FirebaseFirestore
                                                                      ...
                                                                      .collection(
                                                                      "baby&kids")
                                                                      .doc("baby&kids").collection("kidesArrivals").doc(items.id)
                                                                      .delete();
                                                                  ScaffoldMessenger
                                                                      .of(
                                                                      context)
