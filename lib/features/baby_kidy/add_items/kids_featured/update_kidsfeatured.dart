...
class UpdateKidsfeatured extends StatefulWidget {
  BabyModel babyModel;
  UpdateKidsfeatured({super.key,required this.babyModel});

  @override
  State<UpdateKidsfeatured> createState() => _UpdateKidsfeaturedState();
}

class _UpdateKidsfeaturedState extends State<UpdateKidsfeatured> {
                ...
                onPressed: () {
                  if(Name_controller.text!=""&&rate_controller.text!=""
                    ...
                    FirebaseFirestore.instance.collection("baby&kids").doc("baby&kids")
                        .collection("kidsFeatured").doc(widget.babyModel.id).update(
                        {
                          "name":Name_controller.text,
                          "rate":double.tryParse(rate_controller.text)   ,
                          "total":double.tryParse(Totel_controller.text)
